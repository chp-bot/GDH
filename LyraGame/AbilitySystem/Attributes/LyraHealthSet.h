...
public:
	...
	/*
	ATTRIBUTE_ACCESSORS(ULyraHealthSet, Stemina);
	ATTRIBUTE_ACCESSORS(ULyraHealthSet, MaxStemina);
	ATTRIBUTE_ACCESSORS(ULyraHealthSet, HealingStemina);
	ATTRIBUTE_ACCESSORS(ULyraHealthSet, DamageStemina);
	*/
...
protected:
	...
	/*
	UFUNCTION()
	void OnRep_Stemina(const FGameplayAttributeData& OldValue);

	UFUNCTION()
	void OnRep_MaxStemina(const FGameplayAttributeData& OldValue);
	*/

//	void SetStemina_Implementation(const float NewStemina);
...
private:
	...
	/*
	// +Stemina
	UPROPERTY(BlueprintReadOnly, Category = "Lyra|Stemina", Meta = (AllowPrivateAccess = true))
	FGameplayAttributeData HealingStemina;

	// -Stemina
	UPROPERTY(BlueprintReadOnly, Category = "Lyra|Stemina", Meta = (HideFromModifiers, AllowPrivateAccess = true))
	FGameplayAttributeData DamageStemina;
	*/
};
